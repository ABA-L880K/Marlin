...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 160 //50(NG?) //160(Default)
  ...
  #define DELTA_HEIGHT 358.00 //408.00//<-DialGageAdj //358.00 // get this value from auto calibrate (for G28)

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 201.6 // 201.5//201.9// 202.9 //203.11// mm
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -17.320 // KosselPro actual: -22.919
#define Y_PROBE_OFFSET_FROM_EXTRUDER -10     // KosselPro actual: -6.304
/**
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 7 //21 //7
